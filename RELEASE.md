...
* If a call originates from VTN or NoTN, and a call move is attempted by the caller, the call will drop. If the call is moved by the recipient, the move is successful. 
